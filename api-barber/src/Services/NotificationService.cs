...
namespace api_barber.Services
{
    ...
    {
        public async Task<ResponseApi<Notification>> CreateAsync(object request)
        {
            try
            {
                Notification entity = ObjectMapper.Map<object, Notification>(request);
        ...
        public async Task<ResponseApi<Notification>> UpdateAsync(string id, object request, string barbershopId)
        {
            try
            {
