...
namespace api_barber.Services
{
    ...
    {
        public async Task<ResponseApi<ServiceType>> CreateAsync(object request)
        {
            try
            {
                ServiceType entity = ObjectMapper.Map<object, ServiceType>(request);
        ...
        public async Task<ResponseApi<ServiceType>> UpdateAsync(string id, object request, string barbershopId)
        {
            try
            {
