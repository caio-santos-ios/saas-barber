namespace api_barber.Interfaces
{
    public interface IAsaasService
    {
        ...
        Task<string> CreateSubscriptionAsync(string asaasCustomerId, string planId, decimal value, api_barber.Requests.Subscription.CreditCardRequest? creditCard = null, object? creditCardHolderInfo = null);
