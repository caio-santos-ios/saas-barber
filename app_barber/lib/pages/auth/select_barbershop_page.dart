...
class _SelectBarbershopPageState extends State<SelectBarbershopPage> {
  ...
  Future<void> _searchByCode(String code) async {
    ...
    if (cleanCode.length != 6) {
      setState(() {
        _errorMessage = 'O código deve conter exatamente 6 dígitos.';
    ...
    try {
      final shop = await _repository.getBarbershopByCode(cleanCode);
      if (!mounted) return;
      ...
      if (shop != null && shop.id.isNotEmpty) {
        ...
        setState(() {
          _errorMessage = 'Nenhuma barbearia encontrada para o código "$cleanCode".';
          _foundBarbershop = null;
        });
      }
    } catch (e) {
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.storefront_rounded, color: primary, size: 30),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                if (_foundBarbershop!.phone.isNotEmpty)
                                  Text(
                                    _foundBarbershop!.phone,
                                    style: TextStyle(
